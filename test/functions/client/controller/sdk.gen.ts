...
export const createDeviceReport = <ThrowOnError extends boolean = false>(options: Options<CreateDeviceReportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateDeviceReportResponse, CreateDeviceReportError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
 ...
 * Get treatment plan
 */
export const getTreatmentPlanByName = <ThrowOnError extends boolean = false>(options: Options<GetTreatmentPlanByNameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTreatmentPlanByNameResponse, GetTreatmentPlanByNameError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
